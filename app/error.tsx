            ...
            <div className="container mx-auto">
                <div className="flex flex-wrap justify-center items-center">
                    <div className=" w-full lg:w-1/2 text-center">
                        <h1 className=" text-4xl text-[#8c6d52] font-semibold mb-5">Error</h1>
                        ...
                        <button className="w-auto px-3 py-3 bg-[#8c6d52] text-white rounded-md" onClick={() => reset()}>Try again</button>
                    </div>
                </div>
            </div>
        </div>
