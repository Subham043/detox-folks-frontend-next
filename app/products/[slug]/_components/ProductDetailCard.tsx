...
import ProductNotifyBtn from "../../_components/Products/ProductNotifyBtn";
        ...
        <div className="w-full py-10">
            <div className="container mx-auto">
                <div className="flex flex-wrap justify-between items-start">
                    <div className="w-full mb-5 lg:w-[48%] bg-white rounded-md box-border lg:sticky lg:top-10 lg:mb-0">
                        <ProductGalleryTabs product_images={data!.product_images.length===0 ?  [data!.image] : data!.product_images.map(item => item.image)} product_videos={data!.product_videos.map(item => ({video_id: item.video, video_link: item.video_link}))} />
                    </div>
