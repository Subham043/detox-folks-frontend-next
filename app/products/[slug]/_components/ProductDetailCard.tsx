        ...
        <div className="w-full py-10">
            <div className="container mx-auto">
                <div className="flex flex-wrap justify-between items-start mt-10">
                    <div className="w-full mb-5 lg:w-[48%] px-10 py-10 bg-white rounded-md box-border lg:sticky lg:top-10 lg:mb-0">
                        <ProductSlider images={data!.product_images.map(item => item.image)} />
                    </div>
                    <div className="w-full lg:w-[48%] px-10 py-10 bg-white rounded-md box-border">
