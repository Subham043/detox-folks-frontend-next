...
import ProductNotifyBtn from "./ProductNotifyBtn";

export default function ProductCard({ id, name, image, slug, product_prices, product_colors, min_cart_quantity, cart_quantity_interval, cart_quantity_specification, taxes, stock_status }:ProductType) {
    ...
    return <div className=" w-full px-1 text-center mb-3">
        <div className=" bg-white px-3 py-4 rounded-sm transition-all hover:scale-110 hover:shadow-xl">
            ...
            <div className="mt-2">
                {
                    stock_status==="OUT OF STOCK" ? <ProductNotifyBtn /> : 
