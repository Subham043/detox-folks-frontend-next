  ...
  return (
    <div className="w-full mb-3">
        <div className=" w-full mb-5">
            <h3 className=" text-xl text-black font-semibold">Select Payment Mode</h3>
            <p className=" text-neutral-500 text-base">All transactions are secure and encrypted.</p>
        </div>
