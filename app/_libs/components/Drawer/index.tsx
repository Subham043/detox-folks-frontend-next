...
export default function Drawer({ children, isOpen, setIsOpen }:Readonly<{
  ...
  return (
    ...
    >
      ...
      >
        <article className="relative w-screen max-w-sm flex flex-col space-y-6 overflow-y-scroll h-full">
          {children}
        </article>
      </section>
      <section
